import type { AppLauncherSettings, ComponentInfo, HomepageSettings, InlinePredictSettings, LlmWikiSettings, MemoryReviewSettings, NoteAssistantSettings, StudySettings } from "./types";
...
export const DEFAULT_COMPONENTS: ComponentInfo[] = [
  ...
  { id: "memoryreview", name: "记忆复习", added: false },
];
...
export const DEFAULT_SETTINGS: HomepageSettings = {
  ...
  memoryReview: DEFAULT_MEMORY_REVIEW_SETTINGS,
};
